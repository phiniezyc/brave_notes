...
function changePage(noteId) {
  ...
  document.querySelector('ul li[data-noteid="' + noteId + '"]').className =
    'active';
...
function savePage(id, title, icon, body) {
  ...
  if (id === undefined) {
    ...
    document.querySelector(
      '.pages-holder li[data-noteid="' + id + '"]')
      .innerText = icon + ' ' + title;
  }

  chrome.runtime.sendMessage(
    { command: 'postNote', data:
    {
        id,
        title,
        body,
...
document.querySelector('.savePage').addEventListener('click', function () {
  const title = document.querySelector('.holder h1').innerText;
  const body = document.querySelector('.holder .post-body').innerHTML;
  const icon = document.querySelector('.holder .icon').innerText;
  const id = document.querySelector('.holder h1').dataset.noteid;

  savePage(id, title, icon, body);
});

function listenForClicks() {
  const lis = document.querySelectorAll('.pages-holder ul li');
  ...
  if (window.firstOpen == false) {
    ...
    try {
      const openNote = localStorage.getItem('_notes_lastOpenPage');
...
!(function (e, o) {
  ...
  function o() {
    for (var e = 0, o = 0, n = arguments.length; o < n; o++)
      e += arguments[o].length;
    var a = Array(e),
      i = 0;
    for (o = 0; o < n; o++)
      for (var r = arguments[o], t = 0, m = r.length; t < m; t++, i++)
        a[i] = r[t];
    return a;
  }
  !(function (e, o) {
  ...
  function r(e, o) {
    ...
    for (
      o.includeContainer &&
        i.call(e, a) &&
        (g = Array.prototype.slice.apply(g)).unshift(e),
        n = 0;
      n < g.length;
      n++
    )
  ...
  function m(e) {
    return !(
      ...
      (function (e) {
        return (
          null === e.offsetParent || 'hidden' === getComputedStyle(e).visibility
        );
      })(e)
    );
  }
  ...
  function d(e, o) {
    return e.tabIndex === o.tabIndex
      ? e.documentOrder - o.documentOrder
      : e.tabIndex - o.tabIndex;
  }
  function u(e) {
    ...
    j =
      ((y = []),
      {
        activateTrap: function (e) {
          ...
          var n = y.indexOf(e);
          -1 === n ? y.push(e) : (y.splice(n, 1), y.push(e));
        },
        deactivateTrap: function (e) {
          var o = y.indexOf(e);
          -1 !== o && y.splice(o, 1), y.length > 0 && y[y.length - 1].unpause();
        },
      });
  function p(e) {
  ...
  var h = function (e, o) {
    ...
    function m(e) {
      if (r.active) {
        clearTimeout(g),
          ...
          j.deactivateTrap(t);
        var o =
          e && void 0 !== e.onDeactivate ? e.onDeactivate : i.onDeactivate;
        return (
          o && o(),
          (e && void 0 !== e.returnFocus
            ...
            p(function () {
              var e;
              k(
                ((e = r.nodeFocusedBeforeActivation), d('setReturnFocus') || e)
              );
            }),
          t
        );
    ...
    function d(e) {
      var o = i[e],
        a = o;
      if (!o) return null;
      if ('string' == typeof o && !(a = n.querySelector(o)))
      ...
      if (
        !(e =
          null !== d('initialFocus')
            ...
            ? n.activeElement
            : r.firstTabbableNode || d('fallbackFocus'))
      )
        throw new Error(
    ...
    function f(e) {
      a.contains(e.target) ||
        (i.clickOutsideDeactivates
          ...
          : (i.allowOutsideClick && i.allowOutsideClick(e)) ||
            e.preventDefault());
    }
    function y(e) {
      a.contains(e.target) ||
        e.target instanceof Document ||
        (e.stopImmediatePropagation(), k(r.mostRecentlyFocusedNode || u()));
    }
    function h(e) {
      if (
      ...
      (function (e) {
        ...
        (function (e) {
          if ((w(), e.shiftKey && e.target === r.firstTabbableNode))
            return e.preventDefault(), void k(r.lastTabbableNode);
          if (!e.shiftKey && e.target === r.lastTabbableNode)
            e.preventDefault(), k(r.firstTabbableNode);
        })(e);
    }
    function b(e) {
      i.clickOutsideDeactivates ||
    ...
    function w() {
      var e = v(a);
      (r.firstTabbableNode = e[0] || u()),
        (r.lastTabbableNode = e[e.length - 1] || u());
    }
    function k(e) {
      e !== n.activeElement &&
        (e && e.focus
    ...
    off: function (e, o) {
      ...
      if (a && o)
        for (var r = 0, t = a.length; r < t; r++)
          a[r].fn !== o && a[r].fn._ !== o && i.push(a[r]);
  ...
  function A(e, o) {
    void 0 === o && (o = []);
    var n = (function e(o) {
        if (['html', 'body', '#document'].includes(z(o)))
  ...
  function F(e) {
    ...
    return !C(e) ||
      !(o = e.offsetParent) ||
      (void 0 !== window.InstallTrigger && 'fixed' === O(o).position)
      ? null
      : o;
  }
  function T(e) {
      ...
      var i,
        ...
        d = {
          ...
          setOptions: function (n) {
            u(),
              (m.options = Object.assign({}, r, {}, m.options, {}, n)),
              (m.scrollParents = {
                reference: _(e) ? A(e) : [],
                popper: A(o),
              });
            var i = (function (e) {
              ...
              [].concat(
                m.options.modifiers.filter(function (e) {
                ...
                a.map(function (e) {
                  return Object.assign(
                    ...
                    e,
                    {},
                    m.options.modifiers.find(function (o) {
                      return o.name === e.name;
                    })
                  );
                })
  ...
  function ae(e) {
    ...
    if (s) {
      var y = T(n);
      y === x(n) && (y = oe(n)),
        i === B && ((u = u - y.clientHeight + a.height), (f = D)),
        i === q && ((d = d - y.clientWidth + a.width), (l = R));
    }
    var j,
      p = Object.assign(
        {
      ...
      : ce(
          (function (e) {
            var o = x(e),
              ...
              a = I(oe(e), o);
            return (
              (a.height = Math.max(a.height, o.innerHeight)),
              (a.width = Math.max(a.width, o.innerWidth)),
              (a.x = -n.scrollLeft),
              (a.y = -n.scrollTop),
              a
            );
    ...
    var a =
        'clippingParents' === o
          ? (function (e) {
              var o = A(e),
                n =
                  ['absolute', 'fixed'].includes(O(e).position) && C(e)
                    ? T(e)
                    : e;
              return _(n)
                ? o.filter(function (e) {
      ...
      t = i.reduce(function (o, n) {
        ...
        return (
          (o.top = Math.max(a.top + i.top, o.top)),
          (o.right = Math.min(a.right - i.right, o.right)),
          (o.bottom = Math.min(a.bottom - i.bottom, o.bottom)),
          (o.left = Math.max(a.left + i.left, o.left)),
          o
        );
      }, de(e, r));
    return (
  ...
  var pe = Y({
      defaultModifiers: [
        ...
        },
        {
          ...
          effect: function (e) {
            ...
            return (
              Object.assign(o.elements.popper.style, n),
              function () {
                Object.keys(o.elements).forEach(function (e) {
                  var a = o.elements[e],
                    i = Object.keys(
                      o.styles.hasOwnProperty(e)
                        ? Object.assign({}, o.styles[e])
                        : n
                    ),
                    r = o.attributes[e] || {},
        ...
        },
        {
          ...
          fn: function (e) {
            var o = e.state,
              ...
              s = m.x,
              c = m.y;
            (o.modifiersData.popperOffsets.x += s),
            ...
            if (!o.modifiersData[a]._skip) {
              for (
                var i,
                  ...
                  y =
                    ((i = [v].concat(f).reduce(function (e, n) {
                      return 'auto' === J(n)
                        ? e.concat(
                            (function (e, o) {
                              void 0 === o && (o = {});
          ...
          fn: function (e) {
            ...
            if (r) {
              var C = 'y' === h ? B : q,
                ...
                V = o.modifiersData['arrow#persistent']
        ...
        },
        {
              ...
              var c = n.modifiersData[a + '#persistent'].padding,
                ...
                v =
                  (n.rects.reference[s] +
                    ...
                    n.rects.popper[s]) /
                    2 -
                  (r[m] - n.rects.reference[m]) / 2,
                l = fe(
                  c[u],
                  n.rects.popper[s] / 2 - d[s] / 2 + v,
                  n.rects.popper[s] - d[s] - c[g]
                ),
                f = m;
          ...
          effect: function (e) {
            var o = e.state,
              ...
              m = void 0 === t ? 0 : t;
            ('string' != typeof r ||
              (r = o.elements.popper.querySelector(r))) &&
              se(o.elements.popper, r) &&
              ((o.elements.arrow = r),
              (o.modifiersData[a + '#persistent'] = {
    ...
    be = (function () {
      ...
      function u(e, o) {
        for (
          var a,
            ...
            p,
            h = (function e(o, n) {
              for (var a, i, r = o.childNodes, m = r.length; m--; )
                3 === (i = (a = r[m]).nodeType)
                  ? n.push(a)
                  : 1 !== i ||
                    ('ownerSVGElement' in a) ||
                    t.test(a.nodeName.toLowerCase()) ||
                    e(a, n);
              return n;
            })(e, []),
            b = h.length;
          ...
          for (
            ...
            if (
              ((l = g.index) !== v && m.appendChild(s(u.slice(v, l), !0)),
              (j = d((y = g[0]))),
              (v = l + y.length),
              (p = o.callback(j, o)),
              j && p)
            ) {
              for (i in (((f = new Image()).onerror = o.onerror),
          ...
          r &&
            (v < u.length && m.appendChild(s(u.slice(v), !0)),
      ...
      function y(e, o) {
        for (var n = [], a = 0, i = 0, r = 0; r < e.length; )
          (a = e.charCodeAt(r++)),
            i
              ? (n.push(
                  (65536 + ((i - 55296) << 10) + (a - 56320)).toString(16)
                ),
                (i = 0))
              : 55296 <= a && a <= 56319
              ? (i = a)
              : n.push(a.toString(16));
        return n.join(o || '-');
      }
    })();
  ...
  var _e = (function () {
    ...
    return (
      (e.prototype.render = function () {
        ...
        return (
          (this.emoji = xe('div', 'emoji-picker__preview-emoji')),
          o.appendChild(this.emoji),
          (this.name = xe('div', 'emoji-picker__preview-name')),
          o.appendChild(this.name),
          this.events.on('showPreview', function (o) {
      ...
      (e.prototype.showPreview = function (e) {
        (this.emoji.innerHTML =
          'native' === this.options.style ? e.emoji : we.parse(e.emoji)),
          (this.name.innerHTML = e.name);
      }),
  ...
  function Se(e, o) {
    return (
      ...
      (function (e, o) {
        ...
        try {
          for (
            var t, m = e[Symbol.iterator]();
            !(a = (t = m.next()).done) &&
            (n.push(t.value), !o || n.length !== o);
            a = !0
          );
        } catch (e) {
          (i = !0), (r = e);
  ...
  try {
    'undefined' != typeof window && (Ie = window),
      'undefined' != typeof document && (Pe = document),
      'undefined' != typeof MutationObserver && MutationObserver,
      'undefined' != typeof performance && (Le = performance);
  } catch (e) {}
  var Ae = (Ie.navigator || {}).userAgent,
    ...
    De =
      ...
      !!Te.documentElement &&
        !!Te.head &&
        'function' == typeof Te.addEventListener &&
        'function' == typeof Te.createElement),
    Re =
      (~Ne.indexOf('MSIE') || Ne.indexOf('Trident/'),
      (function () {
        try {
        } catch (e) {
          return !1;
  ...
  var We = Fe || {};
  We.___FONT_AWESOME___ || (We.___FONT_AWESOME___ = {}),
    We.___FONT_AWESOME___.styles || (We.___FONT_AWESOME___.styles = {}),
    We.___FONT_AWESOME___.hooks || (We.___FONT_AWESOME___.hooks = {}),
    We.___FONT_AWESOME___.shims || (We.___FONT_AWESOME___.shims = []);
  var Je = We.___FONT_AWESOME___,
    Ge = [];
  De &&
    ((Te.documentElement.doScroll ? /^loaded|^c/ : /^loaded|^i|^c/).test(
      Te.readyState
    ) ||
      Te.addEventListener('DOMContentLoaded', function e() {
  ...
  function no(e) {
    ...
    return (
      e.attributes && (e.attributes.fill || o) && (e.attributes.fill = 'black'),
      e
    );
  }
  function ao(e) {
    var o = e.icons,
      ...
      y = [
        Ue.replacementClass,
        r ? ''.concat(Ue.familyPrefix, '-').concat(r) : '',
        f,
      ]
        .filter(function (e) {
  ...
  var io = function () {},
    ro =
      (Ue.measurePerformance && Be && Be.mark && Be.measure,
      function (e, o, n, a) {
        var i,
          r,
          t,
  ...
  function to(e, o) {
    ...
    'function' != typeof Je.hooks.addPack || i
      ? (Je.styles[e] = Oe({}, Je.styles[e] || {}, r))
      : Je.hooks.addPack(e, r),
      'fas' === e && to('fa', o);
  }
  var mo = Je.styles,
    so = Je.shims,
    ...
    Ue.autoAddCss &&
      ...
      (!(function (e) {
        if (e && De) {
          ...
          for (
            var n = Te.head.childNodes, a = null, i = n.length - 1;
            i > -1;
            i--
          ) {
            var r = n[i],
        ...
        (n = [
          {
            ...
            value: function () {
              ...
              Object.keys(i).forEach(function (o) {
                (e.definitions[o] = Oe({}, e.definitions[o] || {}, i[o])),
                  to(o, i[o]),
                  co();
              });
            },
  ...
  var Do = (function () {
      ...
      return (
        (e.prototype.render = function () {
          var e = this;
          return (
            (this.emojiButton = xe('button', 'emoji-picker__emoji')),
            (this.emojiButton.innerHTML =
              'native' === this.options.style
                ? this.emoji.emoji
                : we.parse(this.emoji.emoji)),
    ...
    Ro = (function () {
      function e(e, o, n, a) {
        (this.showVariants = o),
          (this.events = n),
          (this.options = a),
          (this.emojis = e.filter(function (e) {
            return (
              !e.version || parseFloat(e.version) <= parseFloat(a.emojiVersion)
            );
          }));
      }
      return (
        (e.prototype.render = function () {
          ...
          return (
            this.emojis.forEach(function (n) {
              return o.appendChild(
                new Do(n, e.showVariants, !0, e.events, e.options).render()
              );
            }),
            o
          );
    ...
    Vo = (function () {
      function e(e, o, n, a, i) {
        ...
        (this.events = e),
          ...
          (this.emojiData = a.filter(function (e) {
            return (
              e.version &&
              parseFloat(e.version) <= parseFloat(n.emojiVersion) &&
              void 0 !== e.category &&
              i.indexOf(e.category) >= 0
            );
          })),
      ...
      return (
        (e.prototype.render = function () {
          var e = this;
          return (
            (this.searchContainer = xe(
              'div',
              'emoji-picker__search-container'
            )),
            (this.searchField = xe('input', 'emoji-picker__search')),
            (this.searchField.placeholder = this.i18n.search),
            this.searchContainer.appendChild(this.searchField),
            (this.searchIcon = xe('span', 'emoji-picker__search-icon')),
            (this.searchIcon.innerHTML = Ao),
            this.searchIcon.addEventListener('click', function (o) {
              return e.onClearSearch(o);
            }),
            this.searchContainer.appendChild(this.searchIcon),
            this.searchField.addEventListener('keydown', function (o) {
        ...
        (e.prototype.setFocusedEmoji = function (e) {
          if (this.resultsContainer) {
            var o = this.resultsContainer.querySelectorAll(
              '.emoji-picker__emoji'
            );
          ...
          if (this.resultsContainer) {
            ...
            'ArrowRight' === e.key
              ? this.setFocusedEmoji(
                  Math.min(this.focusedEmojiIndex + 1, o.length - 1)
                )
              : 'ArrowLeft' === e.key
              ? this.setFocusedEmoji(Math.max(0, this.focusedEmojiIndex - 1))
              : 'ArrowDown' === e.key
              ? (e.preventDefault(),
                this.focusedEmojiIndex < o.length - this.emojisPerRow &&
                  this.setFocusedEmoji(
                    this.focusedEmojiIndex + this.emojisPerRow
                  ))
              : 'ArrowUp' === e.key
              ? (e.preventDefault(),
                this.focusedEmojiIndex >= this.emojisPerRow &&
              ...
              : 'Escape' === e.key && this.onClearSearch(e);
          }
        }),
          ...
          if (this.searchField.value) {
            ...
            this.events.emit('hidePreview'),
              o.length
                ...
                : this.events.emit(
                    'showSearchResults',
                    new qo(this.i18n.notFound).render()
                  );
          } else
            (this.searchIcon.innerHTML = Ao),
              (this.searchIcon.style.cursor = 'default'),
    ...
    Ho = (function () {
      ...
      return (
        (e.prototype.getEmoji = function (e) {
        ...
        (e.prototype.render = function () {
          ...
          o.addEventListener('click', function (o) {
            o.stopPropagation(),
              e.popup.contains(o.target) || e.events.emit('hideVariantPopup');
          }),
            this.popup.appendChild(
              new Do(this.emoji, !1, !1, this.events, this.options).render()
            ),
            (this.emoji.variations || []).forEach(function (o, n) {
              return e.popup.appendChild(
                new Do(
                  {
                    name: e.emoji.name,
                    emoji: o,
          ...
          return (
            ...
            this.popup.addEventListener('keydown', function (o) {
              'ArrowRight' === o.key
                ? e.setFocusedEmoji(
                    Math.min(
                      e.focusedEmojiIndex + 1,
                      e.popup.querySelectorAll('.emoji-picker__emoji').length -
                        1
                    )
                  )
                : 'ArrowLeft' === o.key
                ? e.setFocusedEmoji(Math.max(e.focusedEmojiIndex - 1, 0))
                : 'Escape' === o.key &&
                  (o.stopPropagation(), e.events.emit('hideVariantPopup'));
            }),
            o.appendChild(this.popup),
            o
          );
        }),
        e
      ...
      return (
        (e.prototype.render = function () {
          var e = this,
            ...
            a = this.options.showRecents
              ? o(['recents'], this.options.categories || ke.categories)
              : this.options.categories || ke.categories;
          return (
            a.forEach(function (o) {
              var a = xe('button', 'emoji-picker__category-button');
              (a.innerHTML = Uo[o]),
                (a.tabIndex = -1),
                (a.title = e.i18n.categories[o]),
                n.appendChild(a),
                e.buttons.push(a),
            ...
            n.addEventListener('keydown', function (o) {
              switch (o.key) {
                case 'ArrowRight':
                  e.events.emit(
                    'categoryClicked',
                    a[(e.activeButton + 1) % e.buttons.length]
                  );
                  break;
                case 'ArrowLeft':
                  e.events.emit(
        ...
        (e.prototype.setActiveButton = function (e, o) {
          ...
          n.classList.remove('active'),
            (n.tabIndex = -1),
            (this.activeButton = e),
            (n = this.buttons[this.activeButton]).classList.add('active'),
            (n.tabIndex = 0),
            o && n.focus();
        }),
        e
      ...
      function e(e, n, a) {
        ...
        (this.events = e),
          ...
          (this.handleKeyDown = function (e) {
            switch (
              (i.emojis.removeEventListener('scroll', i.highlightCategory),
              e.key)
            ) {
              case 'ArrowRight':
                (i.focusedEmoji.tabIndex = -1),
                  i.focusedIndex === i.currentEmojiCount - 1 &&
                  i.currentCategory < i.categories.length
                    ? (i.options.showCategoryButtons &&
                        i.categoryButtons.setActiveButton(++i.currentCategory),
                      i.setFocusedEmoji(0))
                    : i.setFocusedEmoji(i.focusedIndex + 1);
                break;
              case 'ArrowLeft':
                (i.focusedEmoji.tabIndex = -1),
                  0 === i.focusedIndex && i.currentCategory > 0
                    ? (i.options.showCategoryButtons &&
                        i.categoryButtons.setActiveButton(--i.currentCategory),
                      i.setFocusedEmoji(i.currentEmojiCount - 1))
                    : i.setFocusedEmoji(Math.max(0, i.focusedIndex - 1));
                break;
              case 'ArrowDown':
                e.preventDefault(),
                  (i.focusedEmoji.tabIndex = -1),
                  i.focusedIndex + i.emojisPerRow >= i.currentEmojiCount &&
                  i.currentCategory < i.categories.length
                    ? (i.currentCategory++,
                      i.options.showCategoryButtons &&
                        i.categoryButtons.setActiveButton(i.currentCategory),
                      i.setFocusedEmoji(i.focusedIndex % i.emojisPerRow))
                    : i.setFocusedEmoji(i.focusedIndex + i.emojisPerRow);
                break;
              case 'ArrowUp':
                if (
                  (e.preventDefault(),
                  (i.focusedEmoji.tabIndex = -1),
                  i.focusedIndex < i.emojisPerRow && i.currentCategory > 0)
                ) {
          ...
          (this.addCategory = function (e, o) {
            ...
            (n.innerHTML = i.i18n.categories[e] || Ko.categories[e]),
              i.emojis.appendChild(n),
              i.headers.push(n),
              i.emojis.appendChild(new Ro(o, !0, i.events, i.options).render());
          }),
          (this.selectCategory = function (e, o) {
            void 0 === o && (o = !0),
              i.emojis.removeEventListener('scroll', i.highlightCategory),
              i.focusedEmoji && (i.focusedEmoji.tabIndex = -1);
            var n = i.categories.indexOf(e);
            (i.currentCategory = n),
              i.setFocusedEmoji(0, !1),
              i.options.showCategoryButtons &&
                i.categoryButtons.setActiveButton(i.currentCategory, o);
            var a = i.headerOffsets[n];
            (i.emojis.scrollTop = a),
              requestAnimationFrame(function () {
                return i.emojis.addEventListener('scroll', i.highlightCategory);
              });
          }),
          (this.highlightCategory = function () {
            if (
              ...
              0 === e ? (e = 1) : e < 0 && (e = i.headerOffsets.length),
                (i.currentCategory = e - 1),
                i.options.showCategoryButtons &&
                  i.categoryButtons.setActiveButton(i.currentCategory);
            }
          }),
          (this.emojisPerRow = a.emojisPerRow || 8),
          (this.categories = a.categories || ke.categories),
          a.showRecents && (this.categories = o(['recents'], this.categories));
      }
      return (
        (e.prototype.render = function () {
          var e = this;
          return (
            (this.container = xe('div', 'emoji-picker__emoji-area')),
            this.options.showCategoryButtons &&
              ((this.categoryButtons = new Wo(
                this.options,
                this.events,
                this.i18n
              )),
              this.container.appendChild(this.categoryButtons.render())),
            (this.emojis = xe('div', 'emoji-picker__emojis')),
            this.options.showRecents && (Jo.recents = Bo()),
            this.categories.forEach(function (o) {
              return e.addCategory(o, Jo[o]);
            }),
            requestAnimationFrame(function () {
              (e.headerOffsets = Array.prototype.map.call(
                e.headers,
                function (e) {
                  return e.offsetTop;
                }
              )),
                e.selectCategory('smileys', !1),
                (e.currentCategory = e.options.showRecents ? 1 : 0),
                e.options.showCategoryButtons &&
                  e.categoryButtons.setActiveButton(e.currentCategory, !1),
                setTimeout(function () {
                  setTimeout(function () {
                    return e.emojis.addEventListener(
                      'scroll',
                      e.highlightCategory
                    );
                  });
        ...
        Object.defineProperty(e.prototype, 'focusedEmoji', {
          get: function () {
            return this.currentCategoryEl.querySelectorAll(
              '.emoji-picker__emoji'
            )[this.focusedIndex];
          },
          enumerable: !0,
        ...
        (e.prototype.getEmojiCount = function (e) {
          return this.emojis
            .querySelectorAll('.emoji-picker__container')
            [e].querySelectorAll('.emoji-picker__emoji').length;
        }),
  ...
  return (function () {
    ...
    return (
      ...
      (o.prototype.buildPicker = function () {
        var e = this;
        (this.pickerEl = xe('div', 'emoji-picker')),
        ...
        if (this.options.showSearch) {
          var n = new Vo(
            ...
            this.options,
            ke.emoji,
            (this.options.categories || []).map(function (e) {
        ...
        var a,
          i = new Go(this.events, this.i18n, this.options).render();
        o.appendChild(i),
          ...
          this.options.showPreview &&
            this.pickerEl.appendChild(
              new _e(this.events, this.options).render()
            ),
          this.events.on('emoji', function (o) {
            var n = o.emoji,
              i = o.showVariants;
            n.variations && i && e.options.showVariants
              ? (a = new Ho(e.events, n, e.options).render()) &&
                e.pickerEl.appendChild(a)
              : (a && a.parentNode === e.pickerEl && e.pickerEl.removeChild(a),
                'twemoji' === e.options.style
                  ? e.publicEvents.emit('emoji', we.parse(n.emoji))
                  : e.publicEvents.emit('emoji', n.emoji),
                e.options.autoHide && e.hidePicker());
          }),
          this.events.on('hideVariantPopup', function () {
            a &&
          ...
          (this.wrapper = xe('div', 'wrapper')),
          this.wrapper.appendChild(this.pickerEl),
          this.options.rootElement &&
            this.options.rootElement.appendChild(this.wrapper),
          setTimeout(function () {
            document.addEventListener('click', e.onDocumentClick),
              document.addEventListener('keydown', e.onDocumentKeydown);
          });
      }),
      ...
      (o.prototype.showPicker = function (e, o) {
        void 0 === o && (o = {}),
          this.hideInProgress &&
            (clearTimeout(this.destroyTimeout), this.destroyPicker()),
          (this.pickerVisible = !0),
          this.buildPicker(),
          (this.popper = pe(e, this.wrapper, {
      ...
      (o.prototype.togglePicker = function (e, o) {
        void 0 === o && (o = {}),
          this.pickerVisible ? this.hidePicker() : this.showPicker(e, o);
      }),
